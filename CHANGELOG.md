...
> Make sure to create a backup for your world before updating as This update changes some blockstates.

### General

- Updated for 1.20.51
- Now requires Assets+ 1.6.0
- Renamed Basalt Cobblestone to Cobbled Basalt
- Changed `#basaltblocks` suffix to `@basaltblocks`
